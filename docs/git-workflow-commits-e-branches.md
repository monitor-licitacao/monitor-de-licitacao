...
Este documento é a referência operacional para o fluxo de Git do projeto **Monitor de Licitações**. Ele complementa a Regra de Ouro 8 (Higiene de Git) do GEMINI.md com o passo a passo prático.
